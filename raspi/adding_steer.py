...
pwmS1 = GPIO.PWM(servoPin, 50) # GPIO 17, 50Hz frequency
...
class VirtualJoystick(tk.Tk):
    def __init__(self):
        ...
        self.servo_pin = 8  # GPIO pin where the servo is connected
        self.enable1Pin = 7 
        self.enable2Pin = 19 
        self.enable3Pin = 15
        ...
        self.pwmM1 = GPIO.PWM(self.enable1Pin,100)
        self.pwmM2 = GPIO.PWM(self.enable2Pin,100)
        self.pwmM3 = GPIO.PWM(self.enable3Pin,100)
    ...
    def control_motor(Mvalue, motorPin1, motorPin2, pwm):
        if Mvalue > 0:
            # Motor forward
